...
const Hero = ({ tweaks }) => {
  ...
  const headlines = {
    A: { l1: 'Pare de gastar sua energia', l2: 'tentando montar o', l3: 'quebra-cabeça.' },
    B: { l1: 'Tudo que você precisa', l2: 'para abrir sua barbearia.', l3: 'Em um único lugar.' },
    C: { l1: 'Chega de vídeo solto.', l2: 'Aqui está o guia completo', l3: 'pra abrir sua barbearia.' },
  };
      ...
      <div className="container" style={{
        ...
        <div>
          ...
          <p className="lede" style={{ marginTop: 28, color: 'rgba(255,255,255,.78)', maxWidth: 540 }}>
            Do planejamento ao primeiro cliente: legislação, financeiro, identidade visual, atendimento e gestão — tudo em um material coeso, personalizado para o <em style={{ color: 'var(--dourado-clr)' }}>seu perfil</em> e <em style={{ color: 'var(--dourado-clr)' }}>orçamento</em>.
          </p>

          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, marginTop: 36, alignItems: 'center' }}>
            <a href="#oferta" className="btn-primary">
              QUERO O GUIA — R$ 24,90
              <span className="arrow">→</span>
            </a>
            <a href="#modulos" className="btn-ghost">VER OS 9 MÓDULOS</a>
          </div>

          <div style={{ display: 'flex', gap: 24, marginTop: 28, color: 'var(--cinza-medio)', fontSize: 12, fontFamily: 'var(--f-titulo)', flexWrap: 'wrap' }}>
